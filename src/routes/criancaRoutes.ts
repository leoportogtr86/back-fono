...
import { getAllCriancasHandler, getCriancaByIdHandler, createCriancaHandler, updateCriancaHandler, deleteCriancaHandler } from '../controllers/criancaController';
...
criancaRouter.post('/criancas', validateCrianca, handleValidation, verifyTokenHandler, createCriancaHandler);
criancaRouter.put('/criancas/:id', validateCrianca, handleValidation, verifyTokenHandler, updateCriancaHandler);
