...
export const createCrianca = async (
  data: ICreateCriancaData,
...
export const getCriancaById = async (
  id: number,
  fonoaudiologoId: number,
...
export const getAllCriancas = async (
  fonoaudiologoId: number,
): Promise<ICrianca[]> => {
...
export const updateCrianca = async (
  id: number,
  data: IUpdateCriancaData,
  fonoaudiologoId: number,
): Promise<ICrianca | null> => {
  const updatedCrianca = await prisma.crianca.updateMany({
    ...
    data: {
      ...
      data_nascimento: data.data_nascimento
        ...
        : undefined, // Converte a string ISO 8601 para um objeto Date
    },
  });
...
export const deleteCrianca = async (
  id: number,
  fonoaudiologoId: number,
): Promise<ICrianca | null> => {
