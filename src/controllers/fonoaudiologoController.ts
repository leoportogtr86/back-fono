...
export const getAllFonoaudiologosHandler = async (
  req: Request,
  res: Response,
) => {
...
export const getFonoaudiologoByIdHandler = async (
  req: Request,
  res: Response,
) => {
  const { id } = req.params;
...
export const createFonoaudiologoHandler = async (
  req: Request,
  res: Response,
) => {
...
export const updateFonoaudiologoHandler = async (
  req: Request,
  res: Response,
) => {
  const { id } = req.params;
  const { nome, email, senha } = req.body;
  const updatedFonoaudiologo = await updateFonoaudiologo(Number(id), {
    nome,
    email,
    senha,
  });
...
export const deleteFonoaudiologoHandler = async (
  req: Request,
  res: Response,
) => {
  const { id } = req.params;
